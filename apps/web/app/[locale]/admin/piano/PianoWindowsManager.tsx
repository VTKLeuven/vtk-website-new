...
import { deletePianoWindowAction, savePianoWindowAction } from "@/app/actions/piano";
      ...
      <Card className="p-5">
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
              <Label htmlFor="piano-end-time">{nl ? "Tot" : "Until"}</Label>
              <Input
                id="piano-end-time"
                name="endTime"
                type="time"
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              <Label htmlFor="piano-start-date">{nl ? "Geldig vanaf" : "Valid from"}</Label>
              <Input
                id="piano-start-date"
                name="startDate"
                type="date"
              ...
              <p className="mt-1 text-xs text-[#5c667f]">
                {nl ? "Leeg = geen begingrens." : "Empty = no start bound."}
              </p>
            </div>
            <div>
              <Label htmlFor="piano-end-date">{nl ? "Geldig tot en met" : "Valid until (inclusive)"}</Label>
              <Input id="piano-end-date" name="endDate" type="date" defaultValue={editing.endDate} />
              <p className="mt-1 text-xs text-[#5c667f]">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              <Label htmlFor="piano-order">{nl ? "Volgorde" : "Order"}</Label>
              <Input
                id="piano-order"
                name="order"
                type="number"
