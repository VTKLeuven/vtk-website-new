...
import { localDateTimeToUtc, utcToLocalDateTime } from '@/lib/ticketing/time';
...
describe('Brussels local time conversion', () => {
  ...
  it('formats stored instants as Brussels datetime-local values', () => {
    expect(utcToLocalDateTime(new Date('2027-07-15T10:00:00.000Z'))).toBe('2027-07-15T12:00');
    expect(utcToLocalDateTime(new Date('2027-01-15T11:00:00.000Z'))).toBe('2027-01-15T12:00');
  });
});
