...
2. **Studiebevestiging:** alleen wanneer `isStudent` waar is én
   ...
   krijgen deze jaarlijkse gate niet. De vergelijking gebeurt met de
   **bevestigingsronde** (21 september), niet met het werkingsjaar (15 juli) en
   ook niet met de jaarnaam (14 september). Zie `docs/design-decisions.md`.
...
- **Event-driven i.p.v. per-request:** enkel (her)evalueren op de momenten die
  ertoe doen (login, de jaarwissels op 15 juli en 21 september, na het invullen van
